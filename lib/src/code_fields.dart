      ...
      children: <Widget>[
        ...
        Visibility(
          ...
          child: Text(
            ...
            style: themeData.textTheme.caption.copyWith(color: themeData.errorColor).merge(themeData.inputDecorationTheme.errorStyle),
    ...
    return Container(
      ...
      child: Center(
        child: TextFormField(
          ...
          textInputAction: index == controllers.length - 1 ? TextInputAction.done : TextInputAction.next,
          onChanged: (String text) {
            if(text.isEmpty){
              if(index > 0){
                ...
                if(index == 1) controllers[index-1].text = "";
                else controllers[index-1].text = whitespaceCharacter;
              ...
              else if(index == 0 || text.length == 2) FocusScope.of(context).nextFocus();
            }

            if(widget.onChanged != null || widget.onCompleted != null){
              String code = getCode();
